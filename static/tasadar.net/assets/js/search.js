        ...
        if (text.indexOf(' ') > -1) {
            switch (option) {
                ...
                case "sc":
                    ...
                    break;
                case "s":
                    window.location = "https://open.spotify.com/search/" + subtext;
                    break;
                case "y":
                    window.location = "https://www.youtube.com/results?search_query=" + subtext;
                    break;
                case "ipfs":
                    window.location = "https://ipfs.io/ipfs/" + subtext;
                    break;
                case "ipns":
                    window.location = "https://ipfs.io/ipns/" + subtext;
                    break;
                case "tn":
                    window.location = "https://tn.tasadar.net/ipfs/" + subtext;
                    break;
                case "tnn":
                    window.location = "https://tn.tasadar.net/ipns/" + subtext;
                    break;
            }
        } else {
